...
# snapshot (internal docs/ plus agent instructions excluded, fresh single-commit history) and optionally
...
EXCLUDE=("docs" "CLAUDE.md" "AGENTS.md") # paths kept OUT of the public repo (and its history)
