...
struct SettingsView: View {
    ...
    var body: some View {
        ...
        HStack(spacing: 0) {
            ...
            .padding(10)
            .frame(width: 180)
            // Graphite Sand lays both panes on the shared window gradient (Voice look);
            // the other designs keep their contrasting solid sidebar.
            .background(design == .graphiteSand ? Color.clear : design.panelColor)
            ...
            .background(design == .graphiteSand ? Color.clear : design.appColor)
        }
