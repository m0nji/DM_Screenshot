...
public class BlackUtilityThemeTests
{
    ...
    public void WindowsSettingsWindowUsesThemedBlackSurfaces()
    {
        ...
        // Window chrome and the nav sidebar must come from the design system (AppDesignTheme
        // swaps these per design), never hardcoded colors. The window/nav split uses the
        // dedicated DmWindowBackground/DmNavBackground surfaces (Graphite Sand nav redesign).
        Assert.Contains("Background=\"{DynamicResource DmWindowBackground}\"", settings);
        Assert.Contains("Background=\"{DynamicResource DmNavBackground}\"", settings);
    ...
    public void WindowsEditorCanvasUsesSelectedDesignSurface()
    {
        ...
        Assert.Contains("Grid.Column=\"2\" Margin=\"8\" CornerRadius=\"12\"", editor);
